  ...
  <div class="max-w-[1280px] mx-auto px-5 md:px-16 pt-8 pb-4 flex flex-col md:flex-row gap-6">
    ...
    <aside class="w-full md:w-64 shrink-0">
      <div class="sticky top-28 flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="relative">
            ...
            <input
              ...
              class="w-full bg-(--color-savannah-mist) border-none rounded-lg pl-10 pr-3 py-2.5 font-sans text-sm text-(--color-on-surface) placeholder:text-(--color-on-surface-variant) focus:outline-none focus:ring-2 focus:ring-(--color-primary) transition-all"
            />
          </div>
        </div>
        ...
        <!-- u{2500}u{2500} Right: Results u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500}u{2500} -->
    <section class="flex-1 flex flex-col">
      ...
      <div class="flex-1 min-h-[600px] flex flex-col">
        <div v-if="apiLoading" class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div v-for="n in 4" :key="n" class="rounded-xl bg-(--color-surface-container-lowest) border border-(--color-savannah-mist) overflow-hidden animate-pulse">
            <div class="h-64 bg-(--color-surface-container-high)" />
            <div class="p-6 space-y-3">
              <div class="h-4 bg-(--color-surface-container-high) rounded w-[66%]" />
              <div class="h-3 bg-(--color-surface-container-high) rounded w-[50%]" />
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center justify-center gap-2 mt-10 mb-2">
          <button :disabled="page <= 1 || apiLoading" class="w-9 h-9 flex items-center justify-center rounded-full border border-(--color-outline-variant) text-(--color-on-surface-variant) hover:bg-(--color-surface-container) disabled:opacity-30 disabled:cursor-not-allowed transition-colors" @click="fetchRooms(page - 1)">
